...
<ul>Imágenes y gifs que permiten visualizar mejor la página o realizar distintas acciones</ul>
<ul>Funciones y archivo js, algunos inicializados con valores y otros no, mismo que se deberán ir trabajando</ul>

<h3>Antecedentes que deben tener</h3>
<li>Manejo básico de <b>HTML 5</b> y <b>CSS 3</b> y conocimiento de <b>Bootstrap 5</b></li>
<li>Fundamentos de programación básicos</li>
<li>Definición de javascript como lenguaje de programación y qué se puede hacer cuando se enlaza con un sitio web</li>
